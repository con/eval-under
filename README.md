...
<!-- BEGIN CI MATRIX (generated by bin/ci/gen-readme-matrix.sh) -->
| Backend | git-annex test | git testsuite | stress-ng | pjdfstest |
| --- | --- | --- | --- | --- |
| BeeGFS 7.4.6 | [![BeeGFS 7.4.6 / git-annex test](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-7.4.6-git-annex.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![BeeGFS 7.4.6 / git testsuite](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-7.4.6-git.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![BeeGFS 7.4.6 / stress-ng](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-7.4.6-stress-ng.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![BeeGFS 7.4.6 / pjdfstest](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-7.4.6-pjdfstest.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) |
| BeeGFS 8.1.0 | [![BeeGFS 8.1.0 / git-annex test](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-8.1.0-git-annex.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![BeeGFS 8.1.0 / git testsuite](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-8.1.0-git.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![BeeGFS 8.1.0 / stress-ng](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-8.1.0-stress-ng.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![BeeGFS 8.1.0 / pjdfstest](https://raw.githubusercontent.com/con/eval-under/badges/beegfs-8.1.0-pjdfstest.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) |
| NFS (localhost) | [![NFS (localhost) / git-annex test](https://raw.githubusercontent.com/con/eval-under/badges/nfs-git-annex.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![NFS (localhost) / git testsuite](https://raw.githubusercontent.com/con/eval-under/badges/nfs-git.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![NFS (localhost) / stress-ng](https://raw.githubusercontent.com/con/eval-under/badges/nfs-stress-ng.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![NFS (localhost) / pjdfstest](https://raw.githubusercontent.com/con/eval-under/badges/nfs-pjdfstest.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) |
| Loop vfat | [![Loop vfat / git-annex test](https://raw.githubusercontent.com/con/eval-under/badges/loop-vfat-git-annex.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![Loop vfat / git testsuite](https://raw.githubusercontent.com/con/eval-under/badges/loop-vfat-git.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![Loop vfat / stress-ng](https://raw.githubusercontent.com/con/eval-under/badges/loop-vfat-stress-ng.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![Loop vfat / pjdfstest](https://raw.githubusercontent.com/con/eval-under/badges/loop-vfat-pjdfstest.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) |
| Loop ext4 | [![Loop ext4 / git-annex test](https://raw.githubusercontent.com/con/eval-under/badges/loop-ext4-git-annex.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![Loop ext4 / git testsuite](https://raw.githubusercontent.com/con/eval-under/badges/loop-ext4-git.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![Loop ext4 / stress-ng](https://raw.githubusercontent.com/con/eval-under/badges/loop-ext4-stress-ng.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) | [![Loop ext4 / pjdfstest](https://raw.githubusercontent.com/con/eval-under/badges/loop-ext4-pjdfstest.svg)](https://github.com/con/eval-under/actions/workflows/test.yaml) |
<!-- END CI MATRIX -->
...
single matrix workflow. Each run instead renders an SVG per cell onto
the orphan [`badges`](../../tree/badges) branch, and the table above
points at those. Run `bin/ci/gen-readme-matrix.sh` after editing the
matrix to refresh the table itself.
...
| `bin/ci/publish-badges.sh`               | Renders all 20 and force-pushes them to the `badges` branch                  |
| `.github/workflows/test.yaml`            | The whole matrix: one `matrix` job, 20 `test` cells, one `badges` job        |
